...
export default function Menu({ visible, onClose }: MenuProps) {
  ...
  const menuItems = [
    ...
    { label: 'Meu Perfil', path: '/profile', active: false }, // Verifique se o nome é profile ou perfil
          ...
          <View style={[styles.drawer, { backgroundColor: theme.background }]}>
            ...
            <View style={styles.header}>
              <View style={styles.userInfo}>
                ...
                <View>
                  <Text style={[styles.userName, { color: theme.text }]}>User1234</Text>
                  <Text style={{ color: theme.textSecondary, fontSize: 12 }}>Furg</Text>
                </View>
              </View>
            ...
            <View style={styles.menuList}>
              {menuItems.map((item, index) => (
                <View key={index}>
                  ...
                  <View style={[styles.divider, { backgroundColor: '#BCA89F' }]} />
                </View>
              ))}
            </View>
            ...
            <View style={styles.extraDecor}>
              <View style={[styles.divider, { backgroundColor: '#BCA89F', marginTop: 40 }]} />
              <View style={[styles.divider, { backgroundColor: '#BCA89F', marginTop: 40 }]} />
            </View>
          </View>
        </SafeAreaView>
